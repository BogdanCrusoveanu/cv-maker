...
export default function MinimalTemplate({ cvData }: { cvData: CvData }) {
                ...
                {experience.map((exp) => (
                  <div key={exp.id}>
                    ...
                    <div className="text-xs text-gray-500 mb-2">
                      {formatDate(exp.startDate) || "Sept. 20XX"} -{" "}
                      {formatDate(exp.endDate) || "Jul. 20XX"}
                    </div>
                    {exp.description && (
  ...
  return (
    <div className="flex min-h-[90vh]">
      ...
      {/* Yellow Sidebar */}
      <div className="w-1/3 bg-[#F4C430] p-8 flex flex-col gap-8 pb-10">
        {/* Photo */}
        <div>
      ...
      <div className="flex-1 bg-white">
        ...
        <div className="bg-black text-white p-8">
          ...
          {personalInfo.title && (
            <p className="text-sm mt-2 uppercase tracking-wider">
              {personalInfo.title}
            </p>
          )}
        </div>
