import RubyTemplate from "./templates/cv/Ruby";
import AmberTemplate from "./templates/cv/Amber";
import IronTemplate from "./templates/cv/Iron";
import LagoonTemplate from "./templates/cv/Lagoon";
import LimeTemplate from "./templates/cv/Lime";
import ModernTemplate from "./templates/cv/Modern";
import ClassicTemplate from "./templates/cv/Classic";
import MinimalTemplate from "./templates/cv/Minimal";
import NoirTemplate from "./templates/cv/Noir";
import AzureTemplate from "./templates/cv/Azure";
import SlateTemplate from "./templates/cv/Slate";
import CitrusTemplate from "./templates/cv/Citrus";
import MidnightTemplate from "./templates/cv/Midnight";
import AuroraTemplate from "./templates/cv/Aurora";
import AcademicTemplate from "./templates/cv/Academic";
import PolygonalTemplate from "./templates/cv/Polygonal";
import VerdeTemplate from "./templates/cv/Verde";
import OrbitTemplate from "./templates/cv/Orbit";
